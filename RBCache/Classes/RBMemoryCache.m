...
@interface RBCacheKVNode : NSObject {
    @package
    id key;
    id value;
    CFTimeInterval expireDate;
    __unsafe_unretained RBCacheKVNode *prev;
    __unsafe_unretained RBCacheKVNode *next;
}
@end

@implementation RBCacheKVNode
@end



@interface RBCacheDoublyLinkedList : NSObject {
    @package
...
- (void)insertNodeAtHead:(RBCacheKVNode *)node;

- (void)bringNodeToHead:(RBCacheKVNode *)node;

- (void)removeNode:(RBCacheKVNode *)node;

- (RBCacheKVNode *)removeTailNode;

- (void)removeAllNode;

@end

@implementation RBCacheDoublyLinkedList
...
@implementation RBMemoryCache {
    pthread_mutex_t mutexLock;
    RBCacheDoublyLinkedList *list;
...
- (instancetype)initWithName:(NSString *)name
{
    if (self = [super init]) {
        ...
        list = [[RBCacheDoublyLinkedList alloc] init];
...
- (void)setObject:(id)object forKey:(id)key lifeTime:(NSTimeInterval)lifetime
{
    ...
    RBCacheKVNode *node = CFDictionaryGetValue(dict, (__bridge const void *)key);
    ...
    if (list->totalCount > _countLimit) {
        RBCacheKVNode *node = [list removeTailNode];
