...
- (RBKVItem *)dbGetItemForKey:(NSString *)key
{
...
- (RBKVItem *)dbGetItemFromStmt:(sqlite3_stmt *)stmt
{
    int i = 0;
    ...
    RBKVItem *item = [[RBKVItem alloc] init];
...
- (NSArray<RBKVItem *> *)dbGetItemsOrderByExpireDateAscWithLimit:(NSInteger)rowNum
{
